...
public class AccountLedgerEntry extends ContentHashPastContent {
	...
	public AccountLedgerEntry(Id myId/*, String fileType*/, int ledgerEntryNum, Id billsEntry_DHTHash,
			...
			double pre_balance, double balance, Id self_previous_ledgerEntry_DHTHash, Id self_next_ledgerEntry_DHTHash,
			Id other_FBMEntry_DHTHash, Id self_FBMEntry_DHTHash) {
		super(myId);
